function uploadAnnotations(content, username, delete_key) {
    ...
    setDeleteKeytoLocalStorage(delete_key);
    ...
    for (let item of content.items) {
        ...
        item.body.value = "<p>" + formattedDate + "  " + username + " (サーバ上)</p>" + item.body.value;
    }

    content["delete_key"] = delete_key;
...
function setDeleteKeytoLocalStorage(delete_key) {
    localStorage.setItem("delete_key", delete_key);
}